...
class SelectWithClauseTest {
    ...
    class CreateSetBodyClauseTest {
        ...
        void testCreateSetBodyClause(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            ...
            checkNameObjectIdentifiers(createSetBodyClause.compoundId().objectIdentifiers(), 0, "MySet",
            ...
            checkNameObjectIdentifiers(compoundId1.objectIdentifiers(), 1, "Gender", ObjectIdentifier.Quoting.QUOTED);
            ...
            checkNameObjectIdentifiers(compoundId2.objectIdentifiers(), 1, "Gender", ObjectIdentifier.Quoting.QUOTED);
            assertThat(((KeyObjectIdentifier) compoundId2.objectIdentifiers().get(2)).nameObjectIdentifiers())
                    .hasSize(1);
            checkNameObjectIdentifiers(
                    ((KeyObjectIdentifier) compoundId2.objectIdentifiers().get(2)).nameObjectIdentifiers(), 0, "F",
    ...
    class MeasureBodyClauseTest {
        ...
        void testMeasureBodyClause(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            SelectWithClause selectWithClause = mdxParserProvider
                    .newParser("MEASURE NOT NOT NOT NOT NOT NOT NOT", propertyWords).parseSelectWithClause();
    ...
    class CreateCellCalculationBodyClauseTest {
        ...
        void testMeasureBodyClause(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            SelectWithClause selectWithClause = mdxParserProvider
                    .newParser("CELL CALCULATION NOT NOT NOT NOT NOT NOT NOT", propertyWords).parseSelectWithClause();
