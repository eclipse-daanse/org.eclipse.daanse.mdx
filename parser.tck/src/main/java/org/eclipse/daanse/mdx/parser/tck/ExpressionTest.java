...
class ExpressionTest {
    ...
    class CallExpressionTest {
        ...
        @Test
        void testCallExpressionFunctionWithArrayParam(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("FunctionName([arg1, arg2])", propertyWords)
                    .parseExpression();
        ...
        @Test
        void testCallExpressionFunctionWithoutParams(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
        ...
        @Test
        void testCallExpressionFunctionWithOneParam(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
        ...
        @Test
        void testCallExpressionFunctionWithSeveralParams(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("FunctionName(arg1, arg2)", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
        ...
        @Test
        void testCallExpressionFunctionWithSeveralParamsWithArray(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("FunctionName(arg1, [arg2, arg3])", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
            assertThat(((CallExpression) clause).operationAtom()).isEqualTo(new FunctionOperationAtom("FunctionName"));
            assertThat(((CallExpression) clause).expressions()).hasSize(2);
        ...
        void testCallExpressionMethod(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("object.FunctionName()", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
        ...
        @Test
        void testCallExpressionMethodWithParameter(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("object.FunctionName(arg)", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
            assertThat(((CallExpression) clause).operationAtom()).isEqualTo(new MethodOperationAtom("FunctionName"));
            assertThat(((CallExpression) clause).expressions()).hasSize(2);
        ...
        @Test
        void testCallExpressionMethodWithInnerFunction(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("object.FunctionOuter(FunctionInner())", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
        ...
        void testCallExpressionTermCase(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("CASE a WHEN b THEN c END", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
        ...
        void testCallExpressionBraces2(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("{ expression1, expression2 }", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
            assertThat(((CallExpression) clause).expressions()).hasSize(2);
        ...
        void testCallExpressionBraces3(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            ...
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
            // assertThat(((CallExpression) clause).operationAtom()).isEqualTo(new
            // CaseOperationAtom("_CaseMatch"));
            assertThat(((CallExpression) clause).expressions()).hasSize(1);
        ...
        void testCallExpression3(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            MdxExpression clause = mdxParserProvider
                    .newParser("[Measures].[Store Sales]- [Measures].[Store Cost]", propertyWords).parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
        }
        ...
        void test1(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            MdxExpression clause = mdxParserProvider
                    .newParser("COALESCEEMPTY((Measures.[Profit], [Time].[Time].PREVMEMBER), Measures.[Profit])",
                            propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
            ...
            PlainPropertyOperationAtom plainPropertyOperationAtom = (PlainPropertyOperationAtom) callExpression2
                    .operationAtom();
        ...
        void testCallExpressionBraces4(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("{ [a].[a], [a].[b], [a].[c] }", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
            CallExpression callExpression = ((CallExpression) clause);
            // assertThat(((CallExpression) clause).operationAtom()).isEqualTo(new
        ...
        @Test
        void testCallExpressionParentheses(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
        ...
        @Test
        void testCallExpressionParenthesesWithArray(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("( arg1, [arg2, arg3] )", propertyWords)
                    .parseExpression();
            assertThat(clause).isNotNull().isInstanceOf(CallExpression.class);
            assertThat(((CallExpression) clause).operationAtom()).isEqualTo(new ParenthesesOperationAtom());
            assertThat(((CallExpression) clause).expressions()).hasSize(2);
        ...
        @Disabled
        @Test
        void testCallExpressionTermPostfix(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
        ...
        @Test
        void testCallExpressionTermPrefix(@InjectService MdxParserProvider mdxParserProvider)
                throws MdxParserException {
    ...
    class LiteralTest {
        ...
        void testSymbolLiteral(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
            MdxExpression clause = mdxParserProvider.newParser("cast(\"the_date\" as DATE)", propertyWords)
                    .parseExpression();
            assertThat(clause).isInstanceOf(CallExpression.class);
            CallExpression callExpression = (CallExpression) clause;
    ...
    void testIsNull(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
        assertParseExpr("[Measures].[Unit Sales] IS NULL", mdxParserProvider);
    ...
    void testIdComplex(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
        // simple key
        assertParseExpr("[Foo].&[Key1]&[Key2].[Bar]", mdxParserProvider);
        // compound key
        assertParseExpr("[Foo].&[1]&[Key 2]&[3].[Bar]", mdxParserProvider);
        // compound key sans brackets
        assertParseExpr("[Foo].&Key1&Key2 + 4", mdxParserProvider);
        // brackets are required for numbers

        if (false)
            assertParseExprFails("[Foo].&[1]&[Key2]&^3.[Bar]", mdxParserProvider);
        // space between ampersand and key is unacceptable
        assertParseExprFails("[Foo].&^ [Key2].[Bar]", mdxParserProvider);
        // underscore after ampersand is unacceptable
        assertParseExprFails("[Foo].&^_Key2.[Bar]", mdxParserProvider);
        // but underscore is OK within brackets
        assertParseExpr("[Foo].&[_Key2].[Bar]", mdxParserProvider);
    }
    ...
    void testNumbers(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
        ...
        // space bad
//        assertParseExprFails("4 5", mdxParserProvider);
        ...
        assertParseExpr("31415926535897.9314159265358979", mdxParserProvider);
        assertParseExpr("3.141592653589793", mdxParserProvider);
        assertParseExpr("-3141592653589793.14159265358979", mdxParserProvider);
...
//        assertParseExprFails("1.2e3.4", mdxParserProvider);
        assertParseExpr(".00234e0003", mdxParserProvider);
        assertParseExpr(".00234e-0067", mdxParserProvider);
    }

    /**
     * We give the AS operator low precedence, so CAST works as it should but 'expr AS namedSet' does
     * not.
     */
    @Test
    void testAsPrecedence(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
        ...
        assertParseExpr("cast(a and b as string)", mdxParserProvider);

        // medium precedence operator (:) in CAST
        assertParseExpr("cast(a : b as string)", mdxParserProvider);
