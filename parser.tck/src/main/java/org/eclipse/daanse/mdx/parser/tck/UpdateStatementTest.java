...
class UpdateStatementTest {
    ...
    void test1(@InjectService MdxParserProvider mdxParserProvider) throws MdxParserException {
        UpdateStatement clause = mdxParserProvider.newParser(
                "UPDATE CUBE Cube_Name SET ([Measures].[Sales Count], [Time].[Time].[1997].[Q1]) = 55, ([Measures].[Sales Count], [Time].[Time].[1997].[Q2]) = 33 USE_WEIGHTED_ALLOCATION BY 0.5",
                propertyWords).parseUpdateStatement();
