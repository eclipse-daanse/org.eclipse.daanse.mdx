...
@Designate(ocd = CCCMdxParserProvider.Config.class)
...
public class CCCMdxParserProvider implements MdxParserProvider {
    ...
    @ObjectClassDefinition(name = "Daanse MDX Parser (ccc)")
    ...
    public CCCMdxParserProvider() {
        this(DEFAULT_MAX_NESTING);
    }

    public CCCMdxParserProvider(int maxNesting) {
        this.maxNesting = maxNesting;
    }

    @Activate
    public CCCMdxParserProvider(Config config) {
