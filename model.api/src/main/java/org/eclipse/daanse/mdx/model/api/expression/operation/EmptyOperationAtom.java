 ...
 *
 * Used for an empty expression. Empty expressions can occur within function calls, and are denoted
 * by a pair of commas with only whitespace between them, for example
 *
