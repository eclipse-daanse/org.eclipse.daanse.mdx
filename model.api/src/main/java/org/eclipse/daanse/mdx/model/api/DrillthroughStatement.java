...
/**
 * DRILLTHROUGH Statement Retrieves the underlying table rows that were used to create a specified
 * cell in a cube. Syntax DRILLTHROUGH [MAXROWS Unsigned_Integer] MDX SELECT statement [RETURN
 * Set_of_Attributes_and_Measures ] [,Set_of_Attributes_and_Measures ...]
 */
