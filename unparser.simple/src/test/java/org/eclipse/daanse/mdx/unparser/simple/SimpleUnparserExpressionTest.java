...
class SimpleUnparserExpressionTest {
    ...
    class CallExpressionTest {
        ...
        void testCallExpressionFunctionWithArrayParam() {
            ...
            CallExpression callExpression = new CallExpressionR(new FunctionOperationAtom("FunctionName"),
                    List.of(compoundId));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("FunctionName([arg1, arg2])");
        }
        ...
        void testCallExpressionFunctionWithoutParams() {
            ...
            CallExpression callExpression = new CallExpressionR(new FunctionOperationAtom("FunctionName"),
                    List.of(compoundId));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("FunctionName()");
        }
        ...
        void testCallExpressionFunctionWithOneParam() {
            ...
            CallExpression callExpression = new CallExpressionR(new FunctionOperationAtom("FunctionName"),
                    List.of(compoundId));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("FunctionName(arg)");
        }
        ...
        void testCallExpressionMethod() {
            ...
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("object.FunctionName()");
        }
        ...
        void testCallExpressionMethodWithParameter() {
            ...
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("object.FunctionName(arg)");
        }
        ...
        void testCallExpressionMethodWithInnerFunction() {
            NameObjectIdentifier objectIdentifier = new NameObjectIdentifierR("object", Quoting.UNQUOTED);
            CallExpression сallExpression = new CallExpressionR(new FunctionOperationAtom("FunctionInner"), List.of());
            CompoundId compoundId = new CompoundIdR(List.of(objectIdentifier));
        ...
        void testCallExpressionBraces1() {
            ...
            CompoundId compoundId = new CompoundIdR(List.of(objectIdentifier));
            CallExpression callExpression = new CallExpressionR(new BracesOperationAtom(), List.of(compoundId));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("{expression}");
        }
        ...
        void testCallExpressionBraces2() {
            ...
            CallExpression callExpression = new CallExpressionR(new BracesOperationAtom(),
                    List.of(compoundId1, compoundId2));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("{expression1,expression2}");
        }
        ...
        void testCallExpressionBraces3() {
            ...
            CallExpression callExpressionCh = new CallExpressionR(new InfixOperationAtom(":"),
                    List.of(compoundId1, compoundId2));
            CallExpression callExpression = new CallExpressionR(new BracesOperationAtom(), List.of(callExpressionCh));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("{[a] : [c]}");
        }
        ...
        void testCallExpressionBraces4() {
            ...
            CallExpression callExpression = new CallExpressionR(new BracesOperationAtom(),
                    List.of(compoundId1, compoundId2, compoundId3));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("{[a].[a],[a].[b],[a].[c]}");
        }
        ...
        void testCallExpressionParentheses() {
            ...
            CallExpression callExpression = new CallExpressionR(new ParenthesesOperationAtom(),
                    List.of(compoundId1, compoundId2));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("(arg1,arg2)");
        }
        ...
        void testCallExpressionParenthesesWithArray() {
            ...
            CallExpression callExpression = new CallExpressionR(new ParenthesesOperationAtom(),
                    List.of(compoundId1, compoundId2));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("(arg1,[arg2, arg3])");
        }
        ...
        void testCallExpressionTermPostfix() {
            ...
            CallExpression callExpression = new CallExpressionR(new PostfixOperationAtom("IS EMPTY"),
                    List.of(compoundId));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("arg IS EMPTY");
        }
        ...
        void testCallExpressionTermPrefix() {
            NameObjectIdentifier objectIdentifier = new NameObjectIdentifierR("arg", Quoting.UNQUOTED);
            CompoundId compoundId = new CompoundIdR(List.of(objectIdentifier));
            CallExpression callExpression = new CallExpressionR(new PrefixOperationAtom("NOT"), List.of(compoundId));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("NOT arg");
        }
        ...
        void testCallExpressionTermInfix() {
            ...
            CallExpression callExpression = new CallExpressionR(new InfixOperationAtom("AND"),
                    List.of(compoundId, compoundId1));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("arg1 AND arg2");
        }
    ...
    class LiteralTest {
        ...
        void testNumericLiteral1() {
            ...
            assertThat(unparser.unparseExpression(numericLiteral)).asString().isEqualTo("10");
        }

        @Test
        void testNumericLiteral2() {
            NumericLiteral numericLiteral = new NumericLiteralR(BigDecimal.valueOf(10.25));
            assertThat(unparser.unparseExpression(numericLiteral)).asString().isEqualTo("10.25");
        }

        @Test
        void testNumericLiteral3() {
            NumericLiteral numericLiteral = new NumericLiteralR(BigDecimal.valueOf(10.25));
            CallExpression callExpression = new CallExpressionR(new PrefixOperationAtom("-"), List.of(numericLiteral));
            assertThat(unparser.unparseExpression(callExpression)).asString().isEqualTo("- 10.25");
        }

        @Test
        void testNull() {
            NullLiteral nullLiteral = new NullLiteralR();
            assertThat(unparser.unparseExpression(nullLiteral)).asString().isEqualTo("NULL");
        }
    ...
    class ObjectIdentifierTest {
        ...
        void testKeyObjectIdentifier() {
            ...
            KeyObjectIdentifier keyObjectIdentifier = new KeyObjectIdentifierR(
                    List.of(nameObjectIdentifier21, nameObjectIdentifier22, nameObjectIdentifier23));

            NameObjectIdentifier nameObjectIdentifier3 = new NameObjectIdentifierR("y", Quoting.QUOTED);

            CompoundId compoundId = new CompoundIdR(
                    List.of(nameObjectIdentifier1, keyObjectIdentifier, nameObjectIdentifier3));
            assertThat(unparser.unparseExpression(compoundId)).asString().isEqualTo("[x].&foo&[1]&bar.[y]");
        }
    }
