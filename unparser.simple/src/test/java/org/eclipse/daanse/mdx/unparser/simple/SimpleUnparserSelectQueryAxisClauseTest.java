...
class SimpleUnparserSelectQueryAxisClauseTest {
    ...
    @Test
    void test2() {
        SelectQueryAxisClause selectQueryAxisClause = new SelectQueryAxisClauseR(false,
                new CallExpressionR(new BracesOperationAtom(), List.of(
                        new CompoundIdR(List.of(new NameObjectIdentifierR("Customer", ObjectIdentifier.Quoting.QUOTED),
